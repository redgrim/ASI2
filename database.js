...
function llenarDatos5() {
		...
		db = openDatabase(namedatabase, dbversion, displayName, 50 * 1024);	
                    ...
                    db.transaction(function (rx) {
						rx.executeSql("SELECT idrandom FROM RANDOM ", [], function (rx, results) 
						{
						 ...
						 idrand = results.rows.item(5).idrandom;
	...
	function pasar5() {
	 ...
	 db.transaction(function (ax) {
						ax.executeSql("SELECT idrandom FROM RANDOM ", [], function (ax, results) 
						{
						var idrand0 = results.rows.item(5).idrandom;
					
				if(document.getElementById("rdo1").checked){
			ax.executeSql("insert into RESPUESTAU(idpregunta,respuestau)values(?,?)", [idrand0,"resp1"]);
					location.href = 'pregunta7.html';
			}else if(document.getElementById("rdo2").checked){
			ax.executeSql("insert into RESPUESTAU(idpregunta,respuestau)values(?,?)", [idrand0,"resp2"]);
						location.href = 'pregunta7.html';
				}else if(document.getElementById("rdo3").checked){
		...
		db = openDatabase(namedatabase, dbversion, displayName, 50 * 1024);	
                    ...
                    db.transaction(function (rx) {
						rx.executeSql("SELECT idrandom FROM RANDOM ", [], function (rx, results) 
						{
						 ...
						 idrand = results.rows.item(6).idrandom;
...
function pasar6() {
	 ...
	 db.transaction(function (ax) {
						ax.executeSql("SELECT idrandom FROM RANDOM ", [], function (ax, results) 
						{
						idrand0 = results.rows.item(6).idrandom;
					
				if(document.getElementById("rdo1").checked){
			ax.executeSql("insert into RESPUESTAU(idpregunta,respuestau)values(?,?)", [idrand0,"resp1"]);
					location.href = 'pregunta8.html';
			}else if(document.getElementById("rdo2").checked){
			ax.executeSql("insert into RESPUESTAU(idpregunta,respuestau)values(?,?)", [idrand0,"resp2"]);
						location.href = 'pregunta8.html';
				}else if(document.getElementById("rdo3").checked){
...
var numero =1;
		db = openDatabase(namedatabase, dbversion, displayName, 50 * 1024);	
                    ...
                    db.transaction(function (rx) {
						rx.executeSql("SELECT idrandom FROM RANDOM ", [], function (rx, results) 
						{
						 ...
						 idrand = results.rows.item(7).idrandom;
	...
	function pasar7() {
	 ...
	 db.transaction(function (ax) {
						ax.executeSql("SELECT idrandom FROM RANDOM ", [], function (ax, results) 
						{
						idrand0 = results.rows.item(7).idrandom;
					
				if(document.getElementById("rdo1").checked){
			ax.executeSql("insert into RESPUESTAU(idpregunta,respuestau)values(?,?)", [idrand0,"resp1"]);
					location.href = 'pregunta9.html';
			}else if(document.getElementById("rdo2").checked){
			ax.executeSql("insert into RESPUESTAU(idpregunta,respuestau)values(?,?)", [idrand0,"resp2"]);
						location.href = 'pregunta9.html';
				}else if(document.getElementById("rdo3").checked){
	...
	var numero =1;
		db = openDatabase(namedatabase, dbversion, displayName, 50 * 1024);	
                    ...
                    db.transaction(function (rx) {
						rx.executeSql("SELECT idrandom FROM RANDOM ", [], function (rx, results) 
						{
						 ...
						 idrand = results.rows.item(8).idrandom;
	 ...
	 db.transaction(function (ax) {
						ax.executeSql("SELECT idrandom FROM RANDOM ", [], function (ax, results) 
						{
						idrand0 = results.rows.item(8).idrandom;
					
				if(document.getElementById("rdo1").checked){
			ax.executeSql("insert into RESPUESTAU(idpregunta,respuestau)values(?,?)", [idrand0,"resp1"]);
					location.href = 'pregunta10.html';
			}else if(document.getElementById("rdo2").checked){
			ax.executeSql("insert into RESPUESTAU(idpregunta,respuestau)values(?,?)", [idrand0,"resp2"]);
						location.href = 'pregunta10.html';
				}else if(document.getElementById("rdo3").checked){
		...
		db = openDatabase(namedatabase, dbversion, displayName, 50 * 1024);	
                    ...
                    db.transaction(function (rx) {
						rx.executeSql("SELECT idrandom FROM RANDOM ", [], function (rx, results) 
						{
						 ...
						 idrand = results.rows.item(9).idrandom;
...
function pasar9() {
	...
	db.transaction(function (ax) {
						...
						ax.executeSql("SELECT idrandom FROM RANDOM ", [], function (ax, results) 
						{
							idrand0 = results.rows.item(9).idrandom;
